...
const STRINGS = {
  ...
  /* เรียงเลขใหม่ = เปลี่ยนแค่เลขลำดับหน้าชื่อ เนื้อชื่อเดิม parser ไม่กระทบ
   * แยกข้อความออกมาเพราะแทรกของหนึ่งอันทำให้เกิดทีละสิบกว่ารายการ
   * ถ้าลงรายละเอียดทีละคู่ มันจะกลบคำเตือนข้ออื่นในแถบเดียวกันจนไม่มีใครอ่าน */
  'tabs.renumbered': [
    'แท็บถูกเรียงเลขใหม่ {n} อัน (ชื่อรายการเหมือนเดิม)',
    '{n} tabs renumbered (item names unchanged)',
  ],
  'tabs.andMore': ['และอีก {n} อัน', 'and {n} more'],
